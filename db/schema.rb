...
ActiveRecord::Schema.define(version: 20_160_803_033_250) do
  ...
  add_foreign_key 'equation_block_variables', 'article_equation_blocks', on_delete: :cascade
